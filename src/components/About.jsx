  ...
  return (
    <Box className='content-container'>
      <article>
        ...
        <p>{'FunNearby is a cool web app that gathers info from different sites to make a list of all the exciting events happening in your searched location.'}</p>
        <p>{'Discover your city\'s pulse with FunNearby! Effortlessly explore local happenings, from live performances to food festivals, and plan your weekends with ease. With its user-friendly interface and real-time updates, FunNearby ensures you never miss out on the fun. Whether you\'re a local or just passing through, make every day an adventure with FunNearby – your go-to companion for discovering the best events around you.'}</p>
        <h3>{'How to use:'}</h3>
        <ol>
      ...
      <article>
        ...
        <p>{'FunNearby serves as an interface for finding locations using Google Maps, and analyzing that data with OpenAI. Although the app is straightforward and user interaction is minimal, adherence to this usage policy is crucial to maintaining the seamless operation of the app and to ensuring the availability of our service.'}</p>
        ...
        <ul>
          ...
          <li>{'Unauthorized Access: Do not attempt to access or modify any part of FunNearby or its underlying services in an unauthorized manner.'}</li>
        </ul>
      </article>
    </Box>
  );
